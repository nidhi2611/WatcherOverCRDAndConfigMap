module gitlab.eng.vmware.com/nidhig1/logging_infra_nidhi

go 1.20

require gitlab.eng.vmware.com/nsx-allspark_users/lib-go v1.16.11-0.20230612160225-d3c1107ba933
...
require (
	...
	gitlab.eng.vmware.com/nsx-allspark_users/m7/policymodel.git/pkg/k8sclients/1.22 v0.0.0-20230202110455-0b9b862aa8be // indirect
