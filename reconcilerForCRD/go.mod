...
replace (
	github.com/getkin/kin-openapi => github.com/getkin/kin-openapi v0.35.0
	github.com/go-openapi/spec => github.com/go-openapi/spec v0.19.2
	github.com/go-openapi/swag => github.com/go-openapi/swag v0.19.13 // indirect
